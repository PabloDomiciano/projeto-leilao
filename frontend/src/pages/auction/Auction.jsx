  ...
  const deleteAuction = async (auction) => {
    try {
      ...
      toast.current.show({
        severity: "warn",
        summary: "Removido",
        detail: "Leilão removido com sucesso",
      });
      loadAuctions();
    } catch (error) {
      toast.current.show({
        ...
        <Column
          ...
          body={(rowData) =>
            rowData.startDateTime
              ? new Date(rowData.startDateTime).toLocaleString("pt-BR")
              : ""
          }
        ></Column>
        <Column
          ...
          body={(rowData) =>
            rowData.endDateTime
              ? new Date(rowData.endDateTime).toLocaleString("pt-BR")
              : ""
          }
        ></Column>
          ...
          <div className="p-grid">
            ...
            <div className="p-col-12 p-md-6">
              ...
              <Calendar
                ...
                onChange={(e) =>
                  setAuction({ ...auction, startDateTime: e.value })
                }
                showTime
                dateFormat="dd/mm/yy"
              />
            ...
            <div className="p-col-12 p-md-6">
              ...
              <Calendar
                ...
                onChange={(e) =>
                  setAuction({ ...auction, endDateTime: e.value })
                }
                showTime
                dateFormat="dd/mm/yy"
              />
            ...
            <div className="p-col-12 p-md-6">
              ...
              <InputText
                ...
                onChange={(e) =>
                  setAuction({
                    ...auction,
                    incrementValue: parseFloat(e.target.value),
                  })
                }
              />
            </div>
