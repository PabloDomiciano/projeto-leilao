...
const AuctionPublic = () => {
        ...
        auctions.forEach((auction) => {
          stomp.subscribe(`/topic/auction/${auction.id}`, (message) => {
            ...
            setAuctions((prevAuctions) =>
              prevAuctions.map((a) => {
                console.log(
                  a.id === updatedAuction.auctionId ? updatedAuction : a
                );
  ...
  const renderAuctionItem = (auction) => (
    <div className="auction-item">
      ...
      <p>
        <strong>Fim:</strong> {new Date(auction.endDateTime).toLocaleString()}
      </p>
      <p>
        <strong>Incremento:</strong> R$ {auction.incrementValue}
      </p>
      <p>
        <strong>Valor:</strong> R$ {auction.valueBid}
      </p>
      <p>
        <strong>Usuário:</strong> {auction.emailUserBid}
      </p>
      <Button
        label="Ver Detalhes"
